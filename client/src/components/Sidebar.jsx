...
const Sidebar = ({ isOpen, setIsOpen }) => {
  ...
  const allNavigationLinks = [
    ...
    { name: 'Food & Beverage', path: '/food', icon: FiShoppingBag, description: 'Order meals, drinks and groceries', role: 'all' },
    { name: 'Services', path: '/services', icon: FiTool, description: 'Book professional services', role: 'all' },
    { name: 'My Shop', path: '/shop/mine', icon: FiUser, description: 'Manage your shop and orders', role: 'all' },
    { name: 'Analytics', path: '/analytics', icon: FiActivity, description: 'View portal analytics', role: 'all' },
    { name: 'Rider Portal', path: '/rider/dashboard', icon: FiTruck, description: 'View rider portal analytics', role: 'all' },
